...
**Inputs:**
  ...
  - `block-A/A-01.6-info-context.yaml` — контекст от mais
...
4. Прочитаю `outputs/07.007/block-A/A-01.6-info-context.yaml` — контекст от mais
...
current_skill_path = "profiles/mais/skills/crossfunction-analyzer/SKILL.md"
