...
current_skill_path = "profiles/analyst/skills/system-auditor/SKILL.md"
...
if plan_problems:
    ...
    findings.append({
        ...
        "finding": (
            ...
            "(PH-06/07) отмечены human-in-the-loop, оценка (PH-08) — architect/pdca-reporter."
        ),
...
if s037_skill == "profiles/analyst/skills/implementation-lead/SKILL.md":
    findings.append({
        "finding_id": "FD-04",
        "check": "registry",
        "status": "ok",
