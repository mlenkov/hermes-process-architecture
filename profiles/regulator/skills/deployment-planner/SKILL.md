...
**Outputs:**
  - `outputs/07.007/block-A/A-03.6-deployment-plan.yaml` — план внедрения с фазами, gates, milestones (профиль regulator)
...
current_skill_path = "profiles/regulator/skills/deployment-planner/SKILL.md"
